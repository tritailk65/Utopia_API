...
public class FollowController {
    ...
    @PutMapping(value = {"/AcceptRequest/{idTarget}"}, produces = "application/json")
     ...
     @GetMapping(value = {"/GetListFollower"}, produces = "application/json")
      private APIResult getAllFollower(){
        return new APIResult(200,"Ok",null,followService.getAllFollow(null));
    }
}
