...
public class PostLikeController {
    ...
    private APIResult userSavePost(@RequestHeader("Token") Long token, @PathVariable("PostId") Long postid) {
        SavePostLikeVM result = postLikeService.LikePost(token, postid);
